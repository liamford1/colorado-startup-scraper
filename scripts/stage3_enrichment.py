...
def main():
    ...
    output_json = '../outputs/stage3_enriched.json'
    enriched_companies = []
    enriched_urls = set()
    ...
    csv_file = '../outputs/stage2_progress.csv'
    try:
        with open(csv_file, 'r', encoding='utf-8') as f:
            reader = csv.DictReader(f)
            companies_csv = list(reader)
    except FileNotFoundError:
        print(f"Error: {csv_file} not found. Run stage2_scraper.py first.")
        return

    # Load Stage 2 JSON for full scraped content
    json_file = '../outputs/stage2_scraped_data.json'
    scraped_content = {}
    try:
    ...
    for i, company in enumerate(companies, 1):
        ...
        csv_file = '../outputs/stage3_enriched.csv'
        ...
        json_file = '../outputs/stage3_enriched.json'
