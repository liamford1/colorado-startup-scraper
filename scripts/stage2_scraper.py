...
def main():
    ...
    try:
        with open('../outputs/stage1_candidates.json', 'r', encoding='utf-8') as f:
            candidates = json.load(f)
    except FileNotFoundError:
        print("Error: stage1_candidates.json not found. Run stage1_discovery.py first.")
        return

    # Load existing scraped data if it exists
    output_file = '../outputs/stage2_scraped_data.json'
    scraped_data = []
    scraped_urls = set()
    ...
    # CSV progress file
    csv_progress_file = '../outputs/stage2_progress.csv'
    ...
    for i, candidate in enumerate(new_candidates, 1):
        ...
        json_progress_file = '../outputs/stage2_scraped_data.json'
